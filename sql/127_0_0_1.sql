...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Fev-2022 às 18:44
...
('root', '[{\"db\":\"system_guru\",\"table\":\"usuarios\"},{\"db\":\"system_guru\",\"table\":\"grupo_usuarios_has_usuarios\"},{\"db\":\"system_guru\",\"table\":\"produto\"},{\"db\":\"system_guru\",\"table\":\"produto_emprestimo\"},{\"db\":\"system_guru\",\"table\":\"emprestimos\"},{\"db\":\"system_guru\",\"table\":\"grupo_usuarios\"},{\"db\":\"system_guru\",\"table\":\"emprestimos_has_produto\"},{\"db\":\"deposito\",\"table\":\"usuarios\"},{\"db\":\"deposito\",\"table\":\"produto\"}]');
...
('root', '2021-11-29 18:23:29', '{\"Console\\/Mode\":\"show\",\"lang\":\"pt\",\"NavigationWidth\":277,\"Console\\/Height\":-35.029199999999996}');
...
--
CREATE DATABASE IF NOT EXISTS `system_guru` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `system_guru`;
